	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.antMatcher("/api/**")
			...
			.authorizeHttpRequests()
				.antMatchers(HttpMethod.GET,"/api/boisson").permitAll()
				.antMatchers(HttpMethod.GET,"/api/plat").permitAll()
				.antMatchers(HttpMethod.GET,"/api/marchandise").permitAll() 
				.antMatchers(HttpMethod.POST,"/api/user/inscription").permitAll()
				.antMatchers(HttpMethod.POST,"/api/boutique/**").authenticated()
				...
				.antMatchers(HttpMethod.GET,"/api/simulation/**").permitAll()
