...
import SopraAjc.ParcAttractionSpring.services.FamilleService;
import SopraAjc.ParcAttractionSpring.services.MarchandiseService;
import SopraAjc.ParcAttractionSpring.services.PlatService;
...
public class ParcAttractionSpringApplication {
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(ParcAttractionSpringApplication.class, args);
